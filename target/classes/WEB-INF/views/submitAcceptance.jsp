...
<title>Submit Acceptance Form Details</title>
</head>
<body>
<h1>Submit Acceptance Form Details</h1>

	<br>
	<form:form commandName="createApp" action="submitAcceptanceFormDetails.html" method="POST">
...
Skill Set :<form:hidden path="skillSet" value="${createApplicationBean.skillSet}"/>${createApplicationBean.skillSet}
		...
		<br>
		<br>
	Accepted Offer:	 <form:checkbox path="selectedInterview" value="selectedInterview" />
