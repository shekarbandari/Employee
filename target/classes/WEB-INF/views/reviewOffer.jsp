...
<title>Review Offer Details</title>
</head>
<body>
<h1>Review Offer Details</h1>

	<br>
	<form:form commandName="createApp" action="reviewOfferDetails.html" method="POST">
...
Skill Set :<form:hidden path="skillSet" value="${createApplicationBean.skillSet}"/>${createApplicationBean.skillSet}
		...
		<br>
		<br>
	Acceptance Offer ?:	 <form:checkbox path="selectedInterview" value="selectedInterview" />
