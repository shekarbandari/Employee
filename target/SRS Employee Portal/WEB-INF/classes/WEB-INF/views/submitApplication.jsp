...
<title>Submit Application Details here</title>
</head>
<body>
	<h1>Submit Application Details here</h1>
	
	<br>
	<form:form commandName="createApp" action="submitApplicationDetails.html" method="POST">
...
Skill Set :<form:hidden path="skillSet" value="${createApplicationBean.skillSet}"/>${createApplicationBean.skillSet}
		...
		<br>
		<br>
		Submit Application: <form:checkbox path="selectedInterview" value="selectedInterview" /><br><br>
